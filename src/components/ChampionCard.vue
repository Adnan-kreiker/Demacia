...
<template>
  <div v-if="props.champ"
    ...
    <router-link :to="`/champion-info/${champ.id}`" class="hover:cursor-pointer">
      <img height="98" :src="`https://ddragon.leagueoflegends.com/cdn/${patchVersion}/img/champion/${champ.id}.png`" />
