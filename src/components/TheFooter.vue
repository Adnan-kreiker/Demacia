  ...
  <footer class="text-center text-white" style="background-color: #2f2f2f">
    <div class="pt-9">
      <div data-testid="svg-container" class="flex justify-center mb-9">
        ...
        <a href="https://www.linkedin.com/in/adnan-kreiker/" target="_blank"
        ...
        <a data-testid="github-link" href="https://github.com/Adnan-kreiker" target="_blank"
    ...
    <div class="text-center text-white p-4" style="background-color: rgba(0, 0, 0, 0.2)">
      © 2022 Copyright:
      <a class="text-white" href="https://adnan-kreiker.netlify.app/">League of Legends Wikis</a>
