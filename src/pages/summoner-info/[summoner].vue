...
import { NButton, NSelect, NSkeleton, NSpace, NTabPane, NTabs } from 'naive-ui'
import NPagination from 'naive-ui/es/pagination/src/Pagination'
import type { Ref } from 'vue'

import { storeToRefs } from 'pinia'
import type { PlayerLambdaWithIndex, RegionParam, Summoner, SummonerRankedInfo } from '~/types'
import { regionStore, useRegionStore } from '~/stores/region'
...
const { leagueId, rank } = storeToRefs(main)
